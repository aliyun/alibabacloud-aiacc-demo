...
class ResnetModel(model_lib.CNNModel):
  ...
  def __init__(self, model, layer_counts, params=None):
    ...
    super(ResnetModel, self).__init__(model, params.image_size, batch_size, base_lr,
...
def create_resnet18_model(params):
  return ResnetModel('resnet50', (2, 2, 2, 2), params=params)
